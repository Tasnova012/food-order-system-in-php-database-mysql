...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
	...
	{
	?>
	<a class="navbar-brand" style="color:blue; text-decoratio:none;"><i class="far fa-user"><?php echo $cresult['fld_name']; ?></i></a>
	<?php
	}
	?>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/rice.jpg" alt="dhanmondi 27" class="d-block w-100">
    ...
    <div class="carousel-item">
      <img src="img/lunch time.jpg" alt="dhanmondi 27" class="d-block w-70">
      <div class="carousel-caption">
        <h3>dhanmondi 27</h3>
        <p>Thank you!</p>
      </div>   
    ...
    <div class="carousel-item">
      <img src="img/stream rice.jpg" alt="dhanmondi" class="d-block w-90">
      <div class="carousel-caption">
        <h3>dhanmondi</h3>
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-6">
	<div class="container-fluid">
	 <img src="img/Panta_Ilish.jpg" height="300px" width="100%">
	</div>
	 <div class="container">
	 <p style="font-family: 'Lobster', cursive; font-weight:light;  font-size:25px;">বাংলা: পান্তা ইলিশ - ভাজা ইলিশ মাছের টুকরোর সাথে পান্তা ভাত ও শুঁটকি মাছ, আঁচার, ডাল, কাঁচা মরিচ, এবং পিয়াঁজ কুঁচির সংমিশ্রণের একটি ঐতিহ্যবাহী খাবার। এটি পহেলা বৈশাখ উৎসবের একটি জনপ্রিয় খাদ্য</p>
	 </div> borta
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	                  ...
	                  <?php
	                        ...
	                        tbfood on tblvendor.fldvendor_id=tbfood.fldvendor_id where tbfood.food_id='$food_id'");
	                             while($res=mysqli_fetch_assoc($query))
		                            ...
		                            <!--taka-->      <div class="col-sm-3"><i  style="font-size:20px;" class="fas fa-rupee-sign"></i>&nbsp;<span style="color:green; font-size:25px;"><?php echo $res['cost']; ?></span></div>
									                   <form method="post">
	   ...
	   <div class="col-sm-6">
	        <div class="container-fluid">
	             <img src="img/Mutton-Biryani.jpg" height"300px" width="100%"><!--image-->
	        </div>
	        <div class="container">
	        <!--paragraph content--> 
	             <p style="font-family: 'Lobster', cursive; font-weight:light; font-size:25px;">বিরিয়ানি, মশলা, ভাত এবং মাংস বা সবজি দিয়ে তৈরি একটি মিশ্র চালের থালা, মুঘল সেনাবাহিনীর ব্যারাকে তৈরি একটি ক্যাম্প আইটেম ছিল। ভারতীয় উপমহাদেশের বিভিন্ন অংশে এর স্বাদ ভিন্ন। Dhaka, আমরা পুরান (Dhaka পুরনো অংশ) থেকে একটি নির্দিষ্ট হাজী (যিনি হজযাত্রা থেকে ফিরে এসেছেন) বিরিয়ানির মাধ্যমে মানত করতে পারেন। 1939 সাল থেকে পরিচালিত যখন এর মালিক হজ থেকে ফিরে আসেন, হাজী বিরিয়ানি এই তারিখে শুধুমাত্র একটি জিনিস বিক্রি করেন: মাটন বিরিয়ানি। গরুর মাংসের টুকরো টুকরো এবং লম্বা শস্যের চাল দিয়ে তৈরি, এই থালাটি দই পানীয়, বোরহানির সাথে পরিবেশন করা হয়। মরিচ, লবণ, পুদিনা পাতা এবং আরও অনেক কিছু সহ মশলা দিয়ে তৈরি, বোরহানি হল যেকোনো জিনিস ধোয়ার সবচেয়ে নিশ্চিত উপায় এবং হাজির বোরহানি নিজস্ব। শুকনো কাঠাল বা কাঁঠালের পাতা দিয়ে তৈরি একটি পাত্রে পরিবেশন করা হাজি বিরিয়ানি একটি পুরান Dhaka</p>
	        </div>
	  </div>
